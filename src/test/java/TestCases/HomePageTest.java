...
public class HomePageTest {
    ...
    public void verifyPageURLAndTitle() {
        ...
        String expectedPageTitle = "TESVAN A COMPANY OF QUALITY";
        home.open();
        String currentUrl = WebDriverRunner.getWebDriver().getCurrentUrl();
        assertEquals(url, currentUrl);

        home.pageTitle().shouldHave(innerText(expectedPageTitle));
    }
    ...
    void verifyHeaderLength() {
        ...
        String expectedHeader = "TESVAN A COMPANY OF QUALITY";

        home.header().shouldHave(text(expectedHeader));
